...
const buttonClassName =
  "relative grid size-[var(--aura-editing-bar-height,2.875rem)] cursor-pointer place-items-center rounded-lg border border-primary/40 bg-base-300/85 text-primary shadow-[0_0_0_1px_color-mix(in_oklch,var(--color-base-300)_48%,transparent),0_0_20px_color-mix(in_oklch,var(--color-primary)_18%,transparent)] backdrop-blur-md transition-colors hover:border-primary hover:bg-base-300 focus-visible:border-primary focus-visible:bg-base-300";
