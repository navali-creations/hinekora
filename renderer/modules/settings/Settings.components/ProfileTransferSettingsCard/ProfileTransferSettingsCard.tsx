...
function ProfileTransferSettingsCard() {
  ...
  return (
    <section className="col-span-7 grid gap-3 rounded-lg border border-base-content/10 bg-neutral p-3 shadow-lg">
      ...
      {preview && (
        <div className="grid grid-cols-2 items-center gap-2">
          <span>{preview.profileCount} profiles</span>
      ...
      <p className="m-0 text-base-content/60">
        {lastMessage ??
          "Exports profiles, app setup, and clip history. Video files stay in your media folder."}
      </p>
    </section>
  );
}
