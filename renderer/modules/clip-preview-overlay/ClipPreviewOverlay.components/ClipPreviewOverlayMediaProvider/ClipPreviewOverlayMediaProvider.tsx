...
function ClipPreviewOverlayMediaProvider({
  ...
  const mediaCommands = useMemo<ClipPreviewOverlayMediaCommands>(
    () => ({
      ...
      handleToggleFullscreen: workflow.handleToggleFullscreen,
      ...
      handleVideoKeyDown: workflow.handleVideoKeyDown,
    ...
    [
      ...
      workflow.handleToggleFullscreen,
