...
export const AppSettingsSchema = z.object({
  ...
  auraOverlayEnableSnapping: z.boolean().default(false),
  auraOverlayHideLabels: z.boolean().default(false),
  auraOverlayHidePropertiesPanel: z.boolean().default(false),
  clipPreviewOverlayIgnoreGameFocus: z.boolean().default(false),
