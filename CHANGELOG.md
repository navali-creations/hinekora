...
- [`56dcbef`](https://github.com/navali-creations/hinekora/commit/56dcbef458aec9d54e0aa4add4bb6d35bbe39cc6) Thanks [@sbsrnt](https://github.com/sbsrnt)!

  **Added:** Expanded Aura Manager editing with group selection and per-aura appearance controls.

  - **Group editing:** Drag across the aura overlay to select intersecting auras, then move the selected group together without losing its arrangement.
  - **Aura controls:** Hide resize handles and configure outlines, shadows, rounded corners, icon shapes, icon offsets, icon zoom up to 200%, or reset an aura to its defaults from organized property tabs.
  - **Precise positioning:** Position default, arched, and pointer auras with center-relative X and Y offsets. Zero centers an aura, while negative values move it left or down.
  - **Pointer workflow:** Complete a pointer aura with Escape after choosing any supported number of points.
  - **Capture visibility:** The Settings toggle now controls whether every Hinekora overlay appears in Windows screenshots, Hinekora recordings and rewinds, and other capture tools.
  - **Replay feedback:** Replay status notifications use shorter processing and saved messages while preserving actionable failure details.
...
- [`823ef84`](https://github.com/navali-creations/hinekora/commit/823ef8463baf46a8c84163241b46fa5f874434f8) Thanks [@sbsrnt](https://github.com/sbsrnt)!

  **Improved:** Keep using Hinekora while edited videos save.

  Video saves now continue in the background with clear progress and controls, so you can move around the app and return without interrupting the result.

  - **Save progress:** Follow the percentage and estimated time remaining alongside a muted preview, with a compact status available in the sidebar.
  - **Safe navigation:** Keep editing or refresh Hinekora while a video saves, then return through **View** without losing the active save or editor project.
  - **Cancellation:** Cancel from the save view or sidebar after confirmation; unfinished files are removed without adding a Saved Edits entry.
  - **Clear guidance:** Dismissible notices explain background saving, cancellation, and how new edits affect only the next video.
  - **Long edits:** Save edited timelines up to 24 hours long.

- [`1d184b1`](https://github.com/navali-creations/hinekora/commit/1d184b116ae243c073f0eb0a7267695f772ae71e) Thanks [@sbsrnt](https://github.com/sbsrnt)!

  **Added:** Adjustable playback speed for editor clips.

  Set individual timeline clips anywhere from 0.25x slow motion to 16x speed, with timing kept consistent throughout the editing workflow.

  - **Editor controls:** Choose a clip speed from the compact timeline toolbar menu and preview the result immediately.
  - **Timeline editing:** Trimming, splitting, clip placement, and recording bookmarks stay aligned with the selected speed.
  - **Saving and sharing:** Saved edits, clipboard copies, and exported videos preserve the chosen speed, duration, and audio timing.
...
- [`43b5686`](https://github.com/navali-creations/hinekora/commit/43b5686e17d149603b35f11d2674888b4ce2311a) Thanks [@sbsrnt](https://github.com/sbsrnt)!
...
- [`b174914`](https://github.com/navali-creations/hinekora/commit/b1749140e487116bf64b3e6eb8ec73d967c63591) Thanks [@sbsrnt](https://github.com/sbsrnt)!
