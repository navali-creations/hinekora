...
/*
 * Bookmark categories:
 * - map, town, hideout, boss, pinnacle: automatic location/session markers parsed from client log scene lines.
 ...
 *
 * Bookmark sources:
 * - client-log: generated by Path of Exile client log lines.
